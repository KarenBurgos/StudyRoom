//........................variables.................................//
var songsection = document.getElementById("songs-section")
...
var flagVolume = false; // to control if a song is mute
...
var listsongs = [
    ...
    },
    {
        ...
        "artist": "Vocaloid",
        "src": "./music/The Lost One's Weeping.mp3",
        "img": "./player.gif",
        "playing": false
    },
    {
...
function createPlaylist() {
    listsongs.forEach(function (element, index) {
        ...
        div.addEventListener("click", changeSong)
    });

    playSong(listsongs[0].title, listsongs[0].artist, listsongs[0].img, listsongs[0].src)
}
...
function evalcontrol(e) {
    ...
    if(item.id == "play"){
        ...
        listsongs.forEach(function (element, position) {
            if (namesong.innerText == element.title) {
                index = position
            }
        });
